...
class CurrencyInputWatcherTest_daDK {
    ...
    private val locale = Locale.Builder().setLanguageTag("da-DK").build()
    ...
    @Test
    fun `Should_setTextTo "$ 1point000" _when_textIsSetTo "1000"`() {
    ...
    @Test
    fun `Should_setTextTo "$ 15point420,50" _when_textIsSetTo "15point420,50"`() {
    ...
    @Test
    fun `Should_setTextTo "$ 10point002" _when_previousTextIs "$ 1point000" and "2" isClicked`() {
        val currentEditTextContent = "$ 1.000"
